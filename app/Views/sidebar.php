  ...
  <body class="" style="background-color: #0a1743;">
    <!-- Layout wrapper -->
          ...
          <div class="app-brand demo" style="padding-left: 10px;">
            <a href="index.html" class="app-brand-link">
              <span class="app-brand-logo demo">
               <img src="<?php base_url() ?>assets/img/backgrounds/mli.png" style="max-width: 50px;">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2" style="text-transform: none; font-size: 1.5rem;">MyLittleIsland</span>
            </a>
