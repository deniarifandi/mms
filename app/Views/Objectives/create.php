...
<div class="card card-frame">
  <div class="card-header p-0 position-relative mt-n2 mx-3 z-index-2">
    <div class="bg-gradient-dark shadow-dark border-radius-lg">
      <h6 class="text-white text-capitalize ps-3 m-0 p-2">Add Objective</h6>
    </div>
  </div>
  <div class="card-body">
    <div class="px-4 py-1">
      ...
      <form action="store" method="post">
        <div class="row">
          <div class="col-md-12">
            <div class="input-group input-group-outline my-3" id="objective_name">
              <label class="form-label">Objective's Description</label>
              <input type="text" name="objective_description" class="form-control" value="<?= old('objective_description') ?>" required>
