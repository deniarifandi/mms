...
<div class="card card-frame">
  <div class="card-header p-0 position-relative mt-n2 mx-3 z-index-2">
    <div class="bg-gradient-dark shadow-dark border-radius-lg">
      <h6 class="text-white text-capitalize ps-3 m-0 p-2">Add Assessment</h6>
    </div>
  </div>
  <div class="card-body">
    <div class="px-4 py-1">
      ...
      <form action="store" method="post" enctype="multipart/form-data">
        <div class="row">
          <div class="col-md-12">
            <label class="form-label">1. Assessment's Name</label>
            <div class="input-group input-group-static mb-4" id="asssessment">
              <input type="text" name="assessment" class="form-control" value="<?= old('asssessment') ?>" required>
            </div>
             ...
             <label class="form-label">3. Assessments's Description</label>
             <div class="input-group input-group-static mb-4" id="description">
              <input type="text" name="description" class="form-control" value="<?= old('description') ?>" required>
            </div>

            <label class="form-label">4. Assessments's File <sup>*(doc,docx,ppt,pptx,pdf / 3MB Max)</sup></label>
