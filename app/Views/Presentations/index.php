          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Presentations table <a href="presentations/create" class="btn btn-primary btn-sm float-end my-0 me-3">Add Presentation</a> </h6>
              </div>
            </div>
            <div class="card-body px-0 pb-2">
              <div class="table-responsive px-5">
                <table class="table align-items-center table-striped mb-0" id="presentationsTable">
                  <thead>
                    <tr>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Deleting this presentation will remove all associated data permanently. Continue?
      </div>
      <div class="modal-footer">
        <button type="button" class="btn bg-gradient-secondary" data-bs-dismiss="modal">Close</button>
        
        <form action="/presentations/delete/1" method="POST" id="formDelete">
...
<script type="text/javascript">
  new DataTable('#presentationsTable', {
      order: [[0, 'desc']]
  });
</script>
...
<script type="text/javascript">
  ...
  function modalConfirmation(id){
    ...
    console.log(array);
    document.getElementById('deleteModalLabel').innerText = "Delete Presentation '"+array[1][1]+"'";
    document.getElementById('formDelete').action = "presentations/delete/"+array[0][1];
  }
