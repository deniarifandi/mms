...
<div class="card card-frame">
  <div class="card-header p-0 position-relative mt-n2 mx-3 z-index-2">
    <div class="bg-gradient-dark shadow-dark border-radius-lg">
      <h6 class="text-white text-capitalize ps-3 m-0 p-2">Edit Presentation</h6>
    </div>
  </div>
  <div class="card-body">
    <div class="px-4 py-1">
      ...
      <form action="<?= base_url() ?>/presentations/update/<?= $data['presentation_id'] ?>" method="post"  enctype="multipart/form-data">
        <div class="row">
          <div class="col-md-12">
            <div class="input-group input-group-outline my-3 is-filled" id="presentation">
              <label class="form-label">Presentation's Name</label>
              <input type="text" name="presentation" class="form-control" value="<?= $data['presentation'] ?>" required>
            ...
            <label class="form-label text-dark">3. Presentation's Description</label>
            ...
            <label class="form-label text-dark">4. Presentation's File <sup>*(doc,docx,ppt,pptx,pdf / 3MB Max)</sup></label>
