...
<div class="card card-frame">
  <div class="card-header p-0 position-relative mt-n2 mx-3 z-index-2">
    <div class="bg-gradient-dark shadow-dark border-radius-lg">
      <h6 class="text-white text-capitalize ps-3 m-0 p-2">Edit Case</h6>
    </div>
  </div>
  <div class="card-body">
    <div class="px-4 py-1">
      ...
      <form action="<?= base_url() ?>/cases/update/<?= $data['case_id'] ?>" method="post"  enctype="multipart/form-data">
        <div class="row">
          <div class="col-md-12">
            <label class="form-label">Case's Name</label>
            <div class="input-group input-group-static mb-3 is-filled" id="case_study">
              
              <input type="text" name="case_study" class="form-control" value="<?= $data['case_study'] ?>" required>
            </div>
            ...
            <label class="form-label text-dark">3. Case Study's Description</label>
            ...
            <label class="form-label text-dark">4. Case Study's File <sup>*(doc,docx,ppt,pptx,pdf / 3MB Max)</sup></label>
