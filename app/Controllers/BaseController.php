    ...
    public function initController(RequestInterface $request, ResponseInterface $response, LoggerInterface $logger)
    {
     ...
     public function uploadFile($file,$path){
        ...
        $rules = [
            'file' => [
                'label' => 'File',
                'rules' => 'uploaded[file]|max_size[file,30000]|ext_in[file,doc,docx,ppt,pptx,pdf,mp4,mov,webm,avi,mkv,mpeg,3gp]', // Max size in KB, allowed extensions
            ],
        ];
     ...
     public function uploadVideo($file,$path){
        ...
        $rules = [
            'file' => [
                'label' => 'File',
                'rules' => 'uploaded[file]|max_size[file,30000]|ext_in[file,mp4,mov,webm,avi,mkv,mpeg,3gp]', // Max size in KB, allowed extensions
            ],
        ];
